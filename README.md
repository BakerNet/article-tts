...
- A static file host for the frontend (Cloudflare Pages or any CDN — even GitHub Pages works)
...
4. Name: `Listen TTS`
5. Authorised JavaScript origins: add your PWA's URL (e.g. `https://listen.yourdomain.com`)
...
Edit `frontend/index.html` and replace the value of these 2 items:
...
```bash
npx wrangler pages deploy frontend --project-name listen
```
